...
**被测模块**: `src/services/gateway/gateway.service.ts`
...
**被测模块**: `src/services/connection/connection-manager.ts`
...
└── gateway/
    ├── fault-tolerance.test.ts
    │   └── tests: src/services/gateway/gateway.service.ts
    │
    └── mcp-connection.test.ts
        └── tests: src/services/connection/connection-manager.ts
```
