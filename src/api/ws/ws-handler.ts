...
const eventTypeMap: Record<string, string> = {
  ...
  [EventTypes.SERVER_INSTANCE_ADDED]: WEB_SOCKET_EVENT_TYPES.SERVER_INSTANCE_ADDED,
  [EventTypes.SERVER_INSTANCE_UPDATED]: WEB_SOCKET_EVENT_TYPES.SERVER_INSTANCE_UPDATED,
  [EventTypes.SERVER_INSTANCE_DELETED]: WEB_SOCKET_EVENT_TYPES.SERVER_INSTANCE_DELETED,
