export default {
  ...
  settings: {
    ...
    allowedNetworksHint: 'Allowed IP CIDR ranges (e.g. 192.168.1.0/24)',
    allowedNetworkDeleteTitle: 'Delete IP Range',
    allowedNetworkDeleteConfirm: 'Are you sure you want to delete IP range "{ip}"?',
